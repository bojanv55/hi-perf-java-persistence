...
import me.vukas.jooq.db.tables.records.HibernateSequenceRecord;
...
public class HibernateSequence extends TableImpl<HibernateSequenceRecord> {
    ...
    private static final long serialVersionUID = -318521200;

    /**
     * The reference instance of <code>hi_perf_java_pers.hibernate_sequence</code>
     */
    ...
    /**
     * The column <code>hi_perf_java_pers.hibernate_sequence.next_val</code>.
     */
    public final TableField<HibernateSequenceRecord, Long> NEXT_VAL = createField("next_val", org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * Create a <code>hi_perf_java_pers.hibernate_sequence</code> table reference
     */
    ...
    /**
     * Create an aliased <code>hi_perf_java_pers.hibernate_sequence</code> table reference
     */
